...
<!--
  StudioShell — the protected header/workspace/theme boundary (#73). Every
  Studio route renders inside this shell so the semantic token scope
